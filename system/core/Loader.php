	...
	function _ci_load_class($class, $params = NULL, $object_name = NULL)
	{
		...
		foreach (array(ucfirst($class), strtolower($class)) as $class)
		{
			...
			if (file_exists($subclass))
			{
				...
				{
					log_message('error', "Unable to load the requested class: ".$class.". DEST=".$baseclass);
					show_error("Unable to load the requested class: ".$class.". DEST=".$baseclass);
				}
		...
		{
			log_message('error', "Unable to find the requested class: ".$class);
			show_error("Unable to find the requested class: ".$class);
		}
	}
